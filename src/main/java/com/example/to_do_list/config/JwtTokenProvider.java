...
public class JwtTokenProvider {
    ...
    private static final Long ACCESS_TOKEN_EXPIRE_LENGTH = 1000L * 60 * 60;
    private static final Long REFRESH_TOKEN_EXPIRE_LENGTH = 1000L * 60 * 60 * 24 * 7;
    private static final String AUTHORITIES_KEY = "role";


    private final UsersRepository usersRepository;

    public JwtTokenProvider(@Value("${app.auth.token.secret-key}")String secretKey, @Value("${app.auth.token.refresh-cookie-key}")String cookieKey, UsersRepository usersRepository) {
    ...
    private void saveRefreshToken(Authentication authentication, String refreshToken) {
        ...
        usersRepository.updateRefreshToken(id, refreshToken);
    }
